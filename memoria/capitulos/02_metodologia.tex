...
En este incremento se busca trabajar con APIs de terceros para poder gestionar servicios asociados. Dentro de este paso estarían las conexiones con el GitLab, Microsoft Teams y los servicios de VPN entro otros.


\subsubsection{Incremento V. Auditoría y Cumplimiento}
En este incremento se busca la implementación de un módulo de trazabilidad para medir la robustez. Debido a la estimación en la memoria intermedia de este incremento se debe prescindir. 
...
El primer incremento y cuarto incremento, son los únicos exentos de esta estructura. El primero está exento ya que se definen globalmente los requisitos que se deben cumplir en el sistema y las tecnologías que se van a usar en primera instancia.  El cuarto se encuentra exento ya que se explican posibles soluciones con marco teórico y la integración de Gitlab tienen su propia información. 
...
Diseño de las pantallas que se van a utilizar y los botones que controlan las diferentes pantallas si aplica, junto a la definición de la lógica que se va a utilizar en la implementación. 
