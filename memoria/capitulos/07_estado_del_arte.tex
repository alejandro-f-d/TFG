...
optimizando el rendimiento de la interfaz. \cite{react_meta_docs}

En el contexto de este proyecto, React.js aborda diferentes necesidades.
En primer lugar, el panel de administración de este proyecto, requiere múltiples vistas
...
al trabajo operacional por su mantenimiento y la necesidad de talento
especializado. En
...
El incio de la virtualización se remonta a los años 60 donde se desarrollaron equipos de cómputo muy potentes como los 'mainframes', que debido a su alta capacidad, cierta parte del cómputo quedó sin utilización. Entonces IBM desarrolló un método para ejecutar procesos en paralelo naciendo así las máquinas virtuales. No fue hasta 1999 cuando se dió el siguiente paso, cuando \texttt{VMware} presentó su primer producto, donde se podían ejecutar varios sistemas operativos en la misma máquina. En el 2001 nacen los hipervisores de tipo 1, es decir, aquellos que son capaces de ejecutar directamente sobre el hardware teniendo acceso al mismo. Durante los siguientes años se desarrollaron diversas herramientas para la virtualización, como la aparición de VirtualBox, Microsoft-Hyper-V de máquinas, pero, el siguiente gran hito no fue hasta la aparición de AWS en el año 2012  haciendo uso de la virtualización en sistemas cloud. \cite{icorp_virtualizacion_ti} 
...
biblioteca integrable en una plataforma web, lo que la descarta para este proyecto. La solución adoptada es el Digital Signature Service (DSS), una
...
XAdES entre otras. Su ventaja fundamental frente a otras alternativas es que
...
eliminando el riesgo de desactualización. \cite{eu_digital_signature_service}
