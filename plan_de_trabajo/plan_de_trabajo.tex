...
A continuación se presenta la planificación temporal estimada para el desarrollo del proyecto durante el semestre:
...
\begin{ganttchart}[
    ...
    \gantttitle{Semanas del Semestre}{14} \\
    \gantttitlelist{1,...,14}{1} \\
    \ganttbar{Análisis y BD}{1}{3} \\
    \ganttbar{Backend y API}{3}{6} \\
    \ganttbar{Seguridad}{6}{8} \\
    \ganttbar{Gestión Máquinas}{8}{10} \\
    \ganttbar{Frontend}{10}{13} \\
    \ganttbar{Documentación}{12}{14}
\end{ganttchart}
\end{center}
