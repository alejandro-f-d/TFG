...
El proyecto, consiste en el diseño e implementación de una plataforma integral para la gestión, monitorización y control de infraestructura, servicios y hardware. El sistema busca centralizar la administración de máquinas y servicios tanto externos como internos.
...
\begin{itemize}[label=$\bullet$]
    ...
    \item \textbf{Control de Servicios y Puertos:} Desarrollar un sistema de orquestación para el seguimiento de servicios y puertos asociados.
