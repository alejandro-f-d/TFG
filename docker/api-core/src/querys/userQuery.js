export const USER_QUERIES = {
    ...
    SELECT COUNT(*) FROM medal.usuario 
    WHERE nombre ILIKE $1 AND activo = $2 AND esresponsable = true;
    `,

	COUNT_BY_NOMBRE_GITLAB: `
    SELECT COUNT(*) FROM medal.usuario 
    WHERE nombre ILIKE $1 AND activo = $2 AND gitlab IS NOT NULL;
    `,
};
